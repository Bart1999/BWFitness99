...
import com.example.bwfitness.databinding.ActivityIntermediateBinding;

public class IntermediateActivity extends NavDrawerBaseActivity {

    ActivityIntermediateBinding activityIntermediateBinding;
    EditText which_exercise, target_weight , current_weight , target_sets , current_sets , target_reps, current_reps;

    Button view_workout , new_session3 , overall3;

    DBHelper myDB;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        activityIntermediateBinding = activityIntermediateBinding.inflate(getLayoutInflater());
        setContentView(activityIntermediateBinding.getRoot());
        allocateActivityTitle("Intermediate Advice");
        ...
        new_session3 = findViewById(R.id.new_session3);
        overall3 = findViewById(R.id.overall3);
        myDB = new DBHelper(this);

        new_session3 =(Button) findViewById(R.id.new_session3);
        new_session3.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        overall3 =(Button) findViewById(R.id.overall3);
        ...
        view_workout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(res.getCount()==0){
                    Toast.makeText(IntermediateActivity.this,"No Entry Found",Toast.LENGTH_SHORT).show();
                    return;
                }
