...
import com.example.bwfitness.databinding.ActivityMaintainAdviceBinding;

public class MaintainAdviceActivity extends NavDrawerBaseActivity {

    ActivityMaintainAdviceBinding activityMaintainAdviceBinding;
    ...
    Button view_calorie,new_maintain;

    DBHelper myDB;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        activityMaintainAdviceBinding = activityMaintainAdviceBinding.inflate(getLayoutInflater());
        setContentView(activityMaintainAdviceBinding.getRoot());
        allocateActivityTitle("Maintaining Advice");
        ...
        new_maintain=findViewById(R.id.new_maintain);

        myDB= new DBHelper(this);

        new_maintain =(Button) findViewById(R.id.new_maintain);
        new_maintain.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        view_calorie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(res.getCount()==0){
                    Toast.makeText(MaintainAdviceActivity.this,"No Entry Exists",Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(MaintainAdviceActivity.this);
